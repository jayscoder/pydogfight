...
#         # 如果发现敌方，则朝敌方发射导弹
#         if enemy is not None:
#             hit_point = agent.predict_missile_intercept_point(target_wpt=enemy.waypoint, target_speed=enemy.speed)
...
#                 for agent_tmp in test_agents:
#                     hit_point = agent_tmp.predict_missile_intercept_point(target_wpt=enemy.waypoint)
#                     under_hit_point = enemy.predict_missile_intercept_point(target_wpt=agent_tmp)
