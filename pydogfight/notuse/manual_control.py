...
#                     hit_point = agent_obj.predict_missile_intercept_point(target=enemy)
#                     if hit_point is not None:
#                         self.env.render_info['nearest enemy predict hit distance'] = f'{hit_point.target_distance:.0f}'
#                         self.env.render_info['nearest enemy predict hit time'] = f'{hit_point.time:.1f}'
#                     else:
#                         self.env.render_info['nearest enemy predict hit distance'] = f'inf'
#                         self.env.render_info['nearest enemy predict hit time'] = f'inf'
#                 else:
