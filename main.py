...
parser.add_argument('--folder', type=str, default='scripts/greedy_vs_greedy', help='工作的目录')
...
parser.add_argument('--red', type=str, default='red.xml', help='红方行为树路径，可以是相对于--folder的路径')
parser.add_argument('--blue', type=str, default='blue.xml', help='蓝方行为树路径，可以是相对于--folder的路径')
